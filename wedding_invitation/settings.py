...
CSRF_TRUSTED_ORIGINS = [f"https://{os.environ.get('RAILWAY_STATIC_URL', 'wedding-production-8fc8.up.railway.app')}"]
SECURE_SSL_REDIRECT = False  # Отключить редирект на HTTPS (если возникают проблемы)
